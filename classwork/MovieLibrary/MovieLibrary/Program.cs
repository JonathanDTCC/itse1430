...
namespace MovieLibrary
{
    class Program
    {
        ...
        static void ViewMovie ()
        {
            ...
            //Format arguments
            // Format string - consists of string characters with arguments specified in curly braces as zero-based oridinals
        ...
        static void FunWithStrings ()
        {
            ...
            // 4. Preferred IsNullOrEmpty
            var isEmpty = String.IsNullOrEmpty(emptyString);
